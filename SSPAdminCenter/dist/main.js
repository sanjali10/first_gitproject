...
var map = {
	...
	"./room-list/room-list.module": [
		"./src/app/layout/room-list/room-list.module.ts",
		"room-list-room-list-module~ssp-room-ssp-room-module",
		"common",
		"room-list-room-list-module"
	],
	...
	"./ssp-download/ssp-download.module": [
		"./src/app/layout/ssp-download/ssp-download.module.ts",
		"ssp-download-ssp-download-module"
	],
	"./ssp-room/ssp-room.module": [
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _material_material_module__WEBPACK_IMPORTED_MODULE_8__["AppMaterialModule"],
            ...
            providers: [_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_11__["AuthService"], _shared_services_user_service__WEBPACK_IMPORTED_MODULE_14__["UserService"], _shared__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"], _core_token_storage__WEBPACK_IMPORTED_MODULE_12__["TokenStorage"]],
...
var TOKEN_AUTH_KEY = 'AuthToken';
var TOKEN_USER_KEY = 'UserId';
var TENANT_NAME = 'TENANT_NAME';
var TENANT_VALUE = 'TENANT_VALUE';
...
var TokenStorage = /** @class */ (function () {
    ...
    TokenStorage.prototype.getUsedId = function () {
        return sessionStorage.getItem(TOKEN_USER_KEY);
    };
    TokenStorage.prototype.setTenant = function (tenant) {
    ...
    TokenStorage.prototype.getTenantName = function () {
        return localStorage.getItem(TENANT_NAME);
    };
    TokenStorage.prototype.getTenantValue = function () {
        return localStorage.getItem(TENANT_VALUE);
    };
    TokenStorage.prototype.saveUserDetail = function (userDetail) {
    ...
    TokenStorage.prototype.getPassWord = function () {
        return localStorage.getItem(PASSWORD);
    };
    TokenStorage.prototype.getRememberMe = function () {
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(router, token) {
        this.router = router;
        this.token = token;
    }
    ...
    AuthGuard = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _core_token_storage__WEBPACK_IMPORTED_MODULE_2__["TokenStorage"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var AuthService = /** @class */ (function () {
    function AuthService(http, router, token) {
        this.http = http;
        this.router = router;
        this.token = token;
    }
    ...
    AuthService.prototype.login = function (user) {
        if (user.userName !== '' && user.password !== '') {
            ...
            var loginServiceUrl = this.token.getTenantValue() + '/RESTAPI/sessions';
            return this.http.post(loginServiceUrl, user, httpOptions);
        }
    };
...
var UserService = /** @class */ (function () {
    function UserService(http, router, token) {
        this.http = http;
        this.router = router;
        this.token = token;
    }
    ...
    UserService.prototype.getUserName = function () {
        var getUserNameUrl = this.token.getTenantValue() + '/RESTAPI/users/' + this.token.getUsedId();
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
        ...
        return this.http.get(getUserNameUrl, httpOptions);
    };
...
var environment = {
    ...
    endpoints: {
        arn: 'https://tkpwx516ki.execute-api.eu-west-1.amazonaws.com/dev/api/v1/room',
        key: '8lMI60QsIiaEZtCoVZmCA9YF4BHnE8p25OJYWKCa'
    },
    sspendpoints: {
...
module.exports = __webpack_require__(/*! D:\backup\Anjali-angular\SourceCode\ssp-siam\SSPAdminCenter\src\main.ts */"./src/main.ts");
